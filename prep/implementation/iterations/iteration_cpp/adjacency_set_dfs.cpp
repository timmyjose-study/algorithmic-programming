...
void dfs_pre(graph &g, vector<bool> &visited, int curr_vertex) {
...
void dfs_post(graph &g, vector<bool> &visited, int curr_vertex) {
  visited[curr_vertex] = true;
